    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place:str) -> str:
            ...
            try:
                ...
                log_msg = f"Google cannot find the details due to {e}. \nFollowing are the attractions of {place}: {tavily_result}"
                logger.error(log_msg)  ## Fallback search using tavily in case google places fail
                return log_msg
        @tool
        def search_restaurants(place:str) -> str:
            ...
            try:
                ...
                return log_msg ## Fallback search using tavily in case google places fail
        @tool
